    ...
    internal class Program
    {
        static void Main()
        {
            ...
            { 
                ...
                Write($"\n\t\tFAST       - {iterationsPerAttempt / 1_000_000}m operations   interval: {i2}-{a2}, average: {v2}");
                ...
                Write($"\n\t\tSTANDART   - {totalAttempts * iterationsPerAttempt / 1_000_000}m operations: {s1}");
            ...
            for (var hide = 0; hide < 1; hide++)
            {
                ...
                Write("\n\n\t\t\tBenchmark finished");
                Write($"\n\t\tSTANDART   - {iterationsPerAttempt / 1_000}k operations   interval: {i1}-{a1}, average: {v1}");
